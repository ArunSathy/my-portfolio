...
const Data = () => {
    return (
        <div className="md:col-span-2">
            ...
            <div className="mt-1">
                <h3 className="relative text-h3 pl-[5.4rem] font-normal mb-8 lg:pl-[3.75rem] lg:text-h3 lg:mb-4 md:pl-[2rem] xs:pl-0 before:content-[''] before:absolute before:w-[70px] before:h-[1px] before:bg-text before:left-0 before:top-1/2 before:-translate-y-1/2 lg:before:w-[42px] xs:before:hidden text-title">MERN Stack Developer</h3>
